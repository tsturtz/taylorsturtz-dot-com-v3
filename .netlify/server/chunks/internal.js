    ...
    app: ({ head, body, assets: assets2, nonce, env }) => '\n<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + `/favicon.png" />
		...
		<style>
			...
			*   {
			...
			@font-face {
				font-family: "TheSeasons";
				src: local("TheSeasons"), url("` + assets2 + '/font/TheSeasons/TheSeasons-reg.otf") format("opentype");\n			}\n			@font-face {\n				font-family: "PigeonScout";\n				src: local("PigeonScout"), url("' + assets2 + '/font/PigeonScout/PigeonScout.ttf") format("truetype");\n			}\n			@font-face {\n				font-family: "MoonLight";\n				src: local("MoonLight"), url("' + assets2 + '/font/Moon/MoonLight.otf") format("opentype");\n			}\n			@font-face {\n				font-family: "MoonDark";\n				src: local("MoonDark"), url("' + assets2 + '/font/Moon/MoonDark.otf") format("opentype");\n			}\n			@font-face {\n				font-family: "1942";\n				src: local("1942"), url("' + assets2 + '/font/1942/1942.ttf") format("truetype");\n			}\n			@font-face {\n				font-family: "FiraCode";\n				src: local("FiraCode-Regular"), url("' + assets2 + '/font/FiraCode/FiraCode-Regular.ttf") format("truetype");\n				font-weight: 400;\n				font-style: normal;\n			}\n			@font-face {\n				font-family: "FiraCode";\n				src: local("FiraCode-Bold"), url("' + assets2 + '/font/FiraCode/FiraCode-Bold.ttf") format("truetype");\n				font-weight: 700;\n				font-style: normal;\n			}\n			@font-face {\n				font-family: "JetBrainsMono";\n				src: local("JetBrainsMono-Regular"), url("' + assets2 + '/font/JetBrainsMono/JetBrainsMono-Regular.ttf") format("truetype");\n			}\n			@font-face {\n				font-family: "Garamond";\n				src: local("EBGaramond-Italic-VariableFont_wght"), url("' + assets2 + '/font/Garamond/EBGaramond-Italic.ttf") format("truetype");\n			}\n\n			@media screen and (max-width: 2000px) {\n				.monstera-group {\n					display: none;\n				}\n			}\n		</style>\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover">\n		' + body + "\n	</body>\n</html>\n",
